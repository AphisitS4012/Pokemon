            ...
            <div className='w-[90%] max-w-[600px] m-[auto] '>
                ...
                {pokemon.data && (
                    <div className="rounded-[20px] overflow-hidden shadow  dark:border-gray-700 p-[16px]  m-[auto]">
                        <div className=' bg-center aspect-square bg-cover rounded-[20px] relative w-full h-[400px]'>
                            <img className=" absolute p-[40px] h-[auto] max-h-[400px] aspect-square w-[auto] translate-x-[-50%] translate-y-[-50%] top-[50%] left-[50%]" src="/pic/pokemon_bg.png" alt="" />
                        ...
                        <div className="pt-5 bg-red-700 rounded-[20px] p-[16px] my-[20px]">
                            <div className=' flex justify-between'>

                                <h5 className=" capitalize mb-2 text-xl font-bold tracking-tight  text-white">{pokemon.data.name}</h5>
                                <h5 className="capitalize mb-2 text-xl font-bold tracking-tight  text-white">#{pokemon.data.id}</h5>
                            </div>
                            ...
                            <div className=" grid grid-cols-1 sm:grid-cols-2 gap-x-[20px] gap-y-[30px]">
                                ...
                                <div className=' flex gap-2 justify-start sm:justify-end mt-[16px]'>
                                    {pokemon.data.types.map((item) => {
                                        return <span className={`badge-type-${item.type.name} px-[14px] capitalize py-1 rounded-[12px]`}>{item.type.name}
                                        </span>
                                    })}
                                </div>
                                ...
                                <div className=" mt-[16px]">
                                    ...
                                    <div className=" grid grid-cols-1 gap-[10px] mt-[16px]">
                                        {pokemon.data.abilities.map((item) => {
                                            return <div className={`bg-[#4CAFEB] px-[14px] capitalize py-1 rounded-[12px]`}>{item.ability.name}
                                            </div>
                                        })}
                                    </div>
                                </div>
